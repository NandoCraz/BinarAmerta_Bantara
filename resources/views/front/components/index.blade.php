...
@section('content')
    ...
    <div class="relative bg-cover bg-center h-96 rounded-lg shadow-sm mb-6"
        ...
        <div class="relative flex flex-col justify-center h-full p-6 text-white">
            ...
            <p class="text-lg mb-6">Bantara menghubungkan Anda dengan potensi wisata lokal Indonesia melalui berbagai fitur
                interaktif yang memudahkan pengguna untuk mengeksplorasi dan berpartisipasi dalam kegiatan ekonomi, sosial,
                dan budaya.</p>
        </div>
    </div>
    ...
    <div class="mb-6">
        ...
        <div class="grid grid-cols-6 gap-4">
            <div class="bg-gradient-to-br from-purple-800 via-purple-600 to-purple-400 text-white p-4 rounded-lg shadow-sm">
                ...
                <p class="text-sm text-start">Temukan dan pesan tiket perjalanan dengan rute wisata terdekat menggunakan AI
                    yang terintegrasi dengan Google Maps.</p>
            </div>
            <div class="bg-teal-600 text-white p-4 rounded-lg shadow-sm">
                ...
                <p class="text-sm text-start">Produk lokal khas daerah seperti kuliner, suvenir, madu, dan kopi dari
                    berbagai daerah di Indonesia.</p>
            </div>
            <div class="bg-orange-600 text-white p-4 rounded-lg shadow-sm">
                ...
                <p class="text-sm text-start">Temukan kuliner khas daerah warung kecil hingga restoran besar, lengkap
                    dengan informasi harga dan ulasan.</p>
            </div>
            <div class="bg-purple-600 text-white p-4 rounded-lg shadow-sm">
                ...
                <p class="text-sm text-start">Menjadi sukarelawan dengan bergabung di komunitas sesuai minat, bantuan AI
                    untuk komunikasi diskusi otomatis.</p>
            </div>
            <div class="bg-pink-600 text-white p-4 rounded-lg shadow-sm">
                ...
                <p class="text-sm text-start">Terjemahkan lebih dari 50 bahasa daerah Indonesia secara instan menggunakan
                    teknologi AI untuk komunikasi.</p>
            </div>
            <div class="bg-green-600 text-white p-4 rounded-lg shadow-sm">
                ...
                <p class="text-sm text-start">Konversi mata uang secara real-time untuk transaksi internasional dengan kurs
                    terbaru otomatis.</p>
            </div>
        </div>
    </div>
